...
👉 Opcionalmente, um clone do projeto também poderá ser feito. No terminal do Git, deve-se usar o comando :
...
##### Curso de Qualificação Desenvolvedor FullStack - Módulo BackEnd SENAI-SP.